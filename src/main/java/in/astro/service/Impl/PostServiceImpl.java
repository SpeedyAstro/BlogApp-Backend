...
public class PostServiceImpl implements IPostService {
    ...
    @Override
    public PageResponse getAllPost(int pageNo,int pageSize,String sortBy,String sorting) {
        Sort sort = sorting.equalsIgnoreCase("asc")? Sort.by(sortBy).ascending() : Sort.by(sortBy).descending();
